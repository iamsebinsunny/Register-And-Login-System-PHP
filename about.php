...
<title>Home</title>
	...
	<link rel="stylesheet" href="landingPage/css/owl.carousel.css" type="text/css" media="all">
	<link rel="stylesheet" href="landingPage/css/owl.theme.css" type="text/css" media="all">
	<!-- css files -->
	<link rel="stylesheet" href="landingPage/css/bootstrap.css"> <!-- Bootstrap-Core-CSS -->
	<link rel="stylesheet" href="landingPage/css/style.css" type="text/css" media="all" /> <!-- Style-CSS --> 
	<link rel="stylesheet" href="landingPage/css/fontawesome-all.css"> <!-- Font-Awesome-Icons-CSS -->
	<!-- //css files -->
			...
			<div class="owl-carousel owl-theme">
					...
					<div class="feedback-info">
						...
						<div class="feedback-grids">
							<div class="feedback-img">
								<img src="landingPage/images/team1.jpg" class="img-fluid" alt="" />
							</div>
				...
				<div class="item">
					<div class="feedback-info">
						...
						<div class="feedback-grids">
							<div class="feedback-img">
								<img src="landingPage/images/team3.jpg" class="img-fluid" alt=".." />
							</div>
							<div class="feedback-img-info">
								<h5>Peter Guptill</h5>
								<p>Customer</p>
				...
				<div class="item">
					<div class="feedback-info">
						...
						<div class="feedback-grids">
							<div class="feedback-img">
								<img src="landingPage/images/team4.jpg" class="img-fluid" alt="" />
							</div>
							<div class="feedback-img-info">
								<h5>Steven Wilson</h5>
								<p>Customer</p>
...
<footer >
		...
		<!-- copyright -->
		<div class="footer-cpy text-center pt-sm-3 mt-sm-3 mt-3 pt-3">
			<div class="w3layouts-agile-copyrightbottom">
				<p>© 2021 Car Rental. All Rights Reserved
				</p>
...
<!-- js-scripts -->		
	...
	<!-- js -->
	<script type="text/javascript" src="landingPage/js/jquery-2.1.4.min.js"></script>
	<script type="text/javascript" src="landingPage/js/bootstrap.js"></script> <!-- Necessary-JavaScript-File-For-Bootstrap --> 
	<!-- //js -->
	...
	<!--slider-->
	<script src="landingPage/js/responsiveslides.min.js"></script>
	<script>
		$(function () {
			// Slideshow 1
	...
	<script src="landingPage/js/SmoothScroll.min.js"></script>
	<script type="text/javascript" src="landingPage/js/move-top.js"></script>
	<script type="text/javascript" src="landingPage/js/easing.js"></script>
